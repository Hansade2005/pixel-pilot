          ...
          <Card className="bg-gray-800/50 border-gray-700/50 backdrop-blur-sm mb-8">
            <CardHeader>
              <CardTitle className="text-white flex items-center">
                ...
                Generated by Hans Ade using Pixel Pilot
              </CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-300">
                This template was expertly crafted by Hans Ade using Pixel Pilot's advanced AI capabilities.
                Pixel Pilot combines cutting-edge artificial intelligence with human creativity to deliver
