      ...
      <div className="border-border flex flex-col gap-0 overflow-hidden rounded-md border">
        ...
        >
          <div className="flex flex-1 flex-row items-center gap-2 text-left text-base">
            ...
            <span className="text-sm">AI Agent Operations</span>
...
function SingleToolCard({
            ...
            {parsedResult.map(
              (
                ...
                >
                  ...
                  >
                    {item.title}
                    <FileText className="h-3 w-3 opacity-70 transition-opacity group-hover:opacity-100" />
                  </a>
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex flex-1 flex-row items-center gap-2 text-left text-base">
          <ToolIcon className={cn("size-4", color)} />
          ...
          <AnimatePresence mode="popLayout" initial={false}>
            {isLoading ? (
              ...
              <motion.div
                ...
                key="completed"
              >
                <div className="inline-flex items-center rounded-full border border-green-200 bg-green-50 px-1.5 py-0.5 text-xs text-green-700 dark:border-green-800 dark:bg-blue-950/30 dark:text-green-400">
