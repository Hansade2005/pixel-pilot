        ...
        <div className="relative overflow-hidden rounded-3xl">
          ...
          >
            {features.map((feature, idx) => (
              ...
              >
                <div className="max-w-md mx-auto bg-white/5 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl p-8 flex flex-col justify-between transition-all duration-300 hover:scale-105 hover:border-white/40 hover:bg-white/10">
